...
def execute_case(
    ...
    *,
    ...
    # Keep the interpreter path absolute without resolving its venv symlink.
    # Resolving .venv/bin/python can select a system interpreter that does not
    # have the editable starskill package installed.
...
def build_case_command(
    ...
    *,
    ...
    raise ExecutionError(
        f"automatic capture does not support the {case.workflow!r} workflow"
    )
